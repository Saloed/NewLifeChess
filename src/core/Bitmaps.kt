...
object Bitmaps {
    ...
    val BORDER = -35604928818740737L

    val maps2 = Array(8) { LongArray(64) }
    val cross2Map = LongArray(64)
    val diag2Map = LongArray(64)
    val star2Map = LongArray(64)
    ...
    init {
        ...
        maps2[BM_UR][54] = Long.MIN_VALUE//-9223372036854775808L
        ...
        maps2[BM_U][62] = 0L
        maps2[BM_UR][62] = 0L
        maps2[BM_R][62] = Long.MIN_VALUE//-9223372036854775808L
        ...
        maps2[BM_U][55] = Long.MIN_VALUE//-9223372036854775808L
        maps2[BM_UR][55] = 0L
        maps2[BM_R][55] = 0L
        ...
        for (i in 0..63) {
            cross2Map[i] = maps2[BM_U][i] or maps2[BM_D][i] or maps2[BM_L][i] or maps2[BM_R][i]
            diag2Map[i] = maps2[BM_UR][i] or maps2[BM_DR][i] or maps2[BM_UL][i] or maps2[BM_DL][i]
            star2Map[i] = cross2Map[i] or diag2Map[i]
        }
    }
}
